...
// source: nebula/leverage/v1/gov.proto
...
// registry can be updated in the Nebula capital facility. Note, the registry
...
func init() {
	proto.RegisterType((*UpdateRegistryProposal)(nil), "nebula.leverage.v1.UpdateRegistryProposal")
}

func init() { proto.RegisterFile("nebula/leverage/v1/gov.proto", fileDescriptor_3febb94c702124d7) }
