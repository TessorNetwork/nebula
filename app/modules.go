...
// DefaultGenesis returns custom Nebula x/bank module genesis state.
func (BankModule) DefaultGenesis(cdc codec.JSONCodec) json.RawMessage {
	nebulaMetadata := banktypes.Metadata{
		Description: "The native staking token of the Nebula network.",
	...
	genState.DenomMetadata = append(genState.DenomMetadata, nebulaMetadata)
...
// DefaultGenesis returns custom Nebula x/slashing module genesis state.
