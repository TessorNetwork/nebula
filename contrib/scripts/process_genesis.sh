...
EXPORTED_GENESIS_UNPROCESSED_PATH="${EXPORTED_GENESIS_UNPROCESSED_PATH:-$CWD/nebulamania/nebulamania.genesis.json}"
EXPORTED_GENESIS_PROCESSED_PATH="${EXPORTED_GENESIS_PROCESSED_PATH:-$CWD/nebulamania/tinkered_genesis.json}"
COSMOS_GENESIS_TINKERER_PATH="${COSMOS_GENESIS_TINKERER_PATH:-$CWD/cosmos-genesis-tinkerer}"
COSMOS_GENESIS_TINKERER_SCRIPT="${COSMOS_GENESIS_TINKERER_SCRIPT:-nebulamania-fork.py}"
